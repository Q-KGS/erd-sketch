...
- 소스 수정 후 테스트코드를 수정해야 할 필요가 있다면 테스트 코드도 같이 수정 
...
| Phase 2 | ✅ 완료 | Yjs 실시간 협업, WebSocket 릴레이, 프레즌스/커서, 자동 저장 |
| Phase 3 | ✅ 완료 | MySQL/Oracle/MSSQL DDL, JSON/PNG/SVG 내보내기, DDL 프리뷰 |
| Phase 4 | ✅ 완료 | 버전 히스토리, 댓글, 스키마 Diff, 오프라인, PDF |
| Phase 5 | ✅ 완료 | OAuth, 다크 모드, 팔로우 모드, DBML, JDBC, 프로젝트 템플릿, E2E 자동화 |
