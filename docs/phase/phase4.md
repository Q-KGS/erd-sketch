...
- [ ] E2E-VER-01 (버전 복원) 수동 검증 완료 (예정)
- [ ] E2E-CMT-01 (댓글 + 실시간 표시) 수동 검증 완료 (예정)
- [ ] E2E-DIFF-02 마이그레이션 DDL 실제 DB 실행 성공 (예정)
- [ ] E2E-OFFLINE-01 (오프라인 편집 → 재연결) 수동 검증 완료 (예정)
- [ ] PDF 내보내기 한글 포함 정상 렌더링 확인 (예정)
