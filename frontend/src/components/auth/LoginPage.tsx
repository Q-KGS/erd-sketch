  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <p className="text-center text-gray-500 dark:text-gray-400 mb-8">팀 ERD 설계 도구</p>
        <form onSubmit={(e) => { e.preventDefault(); mutate(form) }} className="space-y-4">
          <div>
            ...
            <input
              ...
              type="email"
              required
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100"
              value={form.email}
        ...
        <div className="space-y-2">
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 font-medium"
